export const englishData = {
   "education-for-children": {
      ...
      description: 'All children have a right to free public education in every state in the USA. Learn about public school in the United States. Find helpful information and know what to expect.',
      content: [
         {
         ...
         },
         {
           ...
           bodyText: ["Public schools are split into different grade levels, from kindergarten to 12th grade. Children usually start school around age 5 and finish around age 18.", 
                     ...
                     "High School (Ages 14 to 18): High school is where students get ready for their future. They take harder classes in things like math and history. They can also choose classes they are interested in and that help prepares them for college or a job."],
           image: '../../assets/images/education-2.jpeg'
         },
         {
         ...
         {
            headerTitle: 'Extracurricular Activiies and Career/College Preparation',
            bodyText: ['lorem ipsum', 'hello', 'yuh'],
            image: '../../assets/images/education-2.jpeg'
         },
